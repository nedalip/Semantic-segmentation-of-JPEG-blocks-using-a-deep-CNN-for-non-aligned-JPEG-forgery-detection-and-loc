...
import os
__file__="E:/image-segmentation-keras-master/"
file_path = os.path.dirname( os.path.abspath(__file__) )
VGG_Weights_path ="E:/image-segmentation-keras-master/vgg16_weights_th_dim_ordering_th_kernels.h5"
# "E:/image-segmentation-keras-master/"
...
def VGGSegnet( n_classes ,  input_height=416, input_width=608 , vgg_level=3):
   ...
   #o = (Activation(activation=softMaxAxis1))(o)
