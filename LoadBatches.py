...
def getImageArr( path , width =WIDTH  , height=HEIGHT , imgNorm="sub_mean" , odering='channels_first' ):
...
def getSegmentationArr( path , nClasses=Nclass ,  width=WIDTH , height=HEIGHT  ):
